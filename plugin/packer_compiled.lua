...
_G.packer_plugins = {
  ...
  ["commentary.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/commentary.nvim",
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/emmet-vim",
  ...
  ["indent-guides.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/indent-guides.nvim",
  ...
  ["nvim-terminal"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-terminal",
  ...
  ["nvim-treesitter-pairs"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-treesitter-pairs",
    url = "https://github.com/theHamsta/nvim-treesitter-pairs"
  },
  ["nvim-treesitter-refactor"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-treesitter-refactor",
  ...
  ["tree-sitter-php"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/tree-sitter-php",
  ...
  ["vim-blade"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-blade",
    url = "https://github.com/jwalton512/vim-blade"
  },
  ["vim-ctrlspace"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-ctrlspace",
    url = "https://github.com/vim-ctrlspace/vim-ctrlspace"
  },
  vimwiki = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vimwiki",
